...
export class TradingViewChartComponent implements OnInit {
    ...
    public _symbol: ChartingLibraryWidgetOptions['symbol'] = 'Bitfinex:BTC/USDT';
    ...
    ngOnInit() {
        ...
        console.log(this.Datafeed, 'Datafeed');
    ...
    supportedResolutions:string[] = ["1", "3", "5", "15", "30", "60", "120", "240","720", "1440"]
