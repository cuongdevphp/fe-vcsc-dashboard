...
export class QrcodeComponent implements OnInit {
    ...
    generate(): void {
        if (this.qrcodeForm.invalid) {
            ...
            if(this.qrcodeForm.value.accountName === '') {
                this.notification.create(
                    'warning',
                    'Generate QR Code fail',
            ...
            if(this.qrcodeForm.value.money === '') {
                this.notification.create(
                    'warning',
                    'Generate QR Code fail',
                    `Please input money`
        ...
        const money = this.amount.toString().replace(/,/g, '');
        const data = {
